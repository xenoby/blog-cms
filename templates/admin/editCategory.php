...
<?php } ?>
        ...
        <ul>
          ...
          <li>
            <label for="description"><?=LANG_CATEGORY_DESCRIPTION?></label>
...
<?php if ( $results['category']->id ) { ?>
      <p><a href="admin.php?action=deleteCategory&amp;categoryId=<?php echo $results['category']->id ?>" onclick="return confirm('Delete This Category?')"><?=LANG_DEL_CATEGORY?></a></p>
<?php } ?>
